...
__CPROVER_requires(__CPROVER_r_ok(Red, sizeof(float)) && __CPROVER_w_ok(Red, sizeof(float)))
__CPROVER_requires(__CPROVER_r_ok(Green, sizeof(float)) && __CPROVER_w_ok(Green, sizeof(float)))
__CPROVER_requires(__CPROVER_r_ok(Blue, sizeof(float)) && __CPROVER_w_ok(Blue, sizeof(float)))
...
__CPROVER_requires(__CPROVER_r_ok(R, sizeof(float)) && __CPROVER_w_ok(R, sizeof(float)))
__CPROVER_requires(__CPROVER_r_ok(G, sizeof(float)) && __CPROVER_w_ok(G, sizeof(float)))
__CPROVER_requires(__CPROVER_r_ok(B, sizeof(float)) && __CPROVER_w_ok(B, sizeof(float)))
