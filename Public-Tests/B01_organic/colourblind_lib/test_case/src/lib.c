...
__CPROVER_ensures(*Red == 0.17055699213417f * __CPROVER_old(*Red) + 0.82944301379913f * __CPROVER_old(*Green) + 2.91188E-9f * __CPROVER_old(*Blue))
__CPROVER_ensures(*Green == 0.17055699092998f * __CPROVER_old(*Red) + 0.82944300785005f * __CPROVER_old(*Green) - 5.98679E-10f * __CPROVER_old(*Blue))
__CPROVER_ensures(*Blue == -0.00451714424166f * __CPROVER_old(*Red) + 0.00451714427397f * __CPROVER_old(*Green) + __CPROVER_old(*Blue))
{
...
__CPROVER_requires(Impairment == cbProtanopia || Impairment == cbDeuteranopia || Impairment == cbTritanopia)
