...
__CPROVER_requires(__CPROVER_r_ok(a, sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_r_ok(b, sizeof(spritebatch_sprite_t)))
__CPROVER_assigns()
...
static void spritebatch_internal_merge_sort_iteration(spritebatch_sprite_t *a, int lo,
                                               int split, int hi,
                                               spritebatch_sprite_t *b)
__CPROVER_requires(lo >= 0 && lo <= split && split <= hi && hi <= 4)
__CPROVER_requires(__CPROVER_r_ok(a, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_w_ok(b, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
...
__CPROVER_requires(lo >= 0 && lo <= hi && hi <= 4)
__CPROVER_requires(__CPROVER_r_ok(a, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_w_ok(a, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_r_ok(b, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_w_ok(b, (unsigned long)hi * sizeof(spritebatch_sprite_t)))
...
__CPROVER_requires(__CPROVER_is_fresh(a, (unsigned long)(size > 0 ? size : 1) * sizeof(spritebatch_sprite_t)))
__CPROVER_requires(__CPROVER_is_fresh(b, (unsigned long)(size > 0 ? size : 1) * sizeof(spritebatch_sprite_t)))
__CPROVER_assigns(__CPROVER_object_whole(a), __CPROVER_object_whole(b))
{
