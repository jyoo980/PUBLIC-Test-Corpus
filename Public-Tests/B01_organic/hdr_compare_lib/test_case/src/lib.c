...
__CPROVER_requires(__CPROVER_r_ok(h, 3 * sizeof(uint8_t)))
__CPROVER_assigns()
{
...
__CPROVER_requires(__CPROVER_r_ok(h1, 3 * sizeof(uint8_t)))
__CPROVER_requires(__CPROVER_r_ok(h2, 3 * sizeof(uint8_t)))
__CPROVER_assigns()
{
